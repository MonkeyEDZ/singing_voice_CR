...
%        parameter.printDir = '';
%        parameter.title = '';
%        parameter.chord = 'chord';   % modificacion propia para
%        visualizar acordes
...
if strcmp(parameter.chord,'chord')==1
...
if all(parameter.imagerange == 0)
    imagesc(t,range,f_chroma);
else
    imagesc(t,range,f_chroma,parameter.imagerange);
end
set(gca,'YTick',range);
