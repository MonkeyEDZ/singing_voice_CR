function [f_pitch,sideinfo] = audio_to_pitch_via_FB_3(f_audio,parameter,sideinfo,featureDens)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Main program
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% lectura de matriz resultado de genFPF
if parameter.shiftFB == 0
    load MIDI_FormantsW_pitch_60_96_22050_Q25.mat
elseif parameter.shiftFB == 1
    load MIDI_FormantsW_pitch_60_96_22050_Q25_minusQuarter.mat
elseif parameter.shiftFB == 2
    load MIDI_FormantsW_pitch_60_96_22050_Q25_minusThird.mat
elseif parameter.shiftFB == 3
    load MIDI_FormantsW_pitch_60_96_22050_Q25_minusHalf.mat
elseif parameter.shiftFB == 4
    load MIDI_FormantsW_pitch_60_96_22050_Q25_minusTwoThird.mat
elseif parameter.shiftFB == 5
    load MIDI_FormantsW_pitch_60_96_22050_Q25_minusThreeQuarters.mat
else
...
winOvSTMSP  =  round(winLenSTMSP/featureDens);
